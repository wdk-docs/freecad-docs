...
Here is the above molecule example, adapted to be drawn only with Coin3D scenegraph objects instead of using objects from the [Part workbench](docs\workbenches\part.md):
...
See [FeaturePython methods](https://wiki.freecad.org/FeaturePython_methods) for the complete reference.
...
See [FeaturePython Custom Properties](https://wiki.freecad.org/FeaturePython_Custom_Properties) for an overview.
...
Example of output property (see also [https://forum.freecadweb.org/viewtopic.php?t=24928](https://forum.freecadweb.org/viewtopic.php?t=24928)):
...
- [Viewproviders](https://wiki.freecad.org/Viewprovider)
...
- [Explanation on **getstate** and **setstate**](https://forum.freecadweb.org/viewtopic.php?f=18&t=44009), [official documentation](https://docs.python.org/3/library/pickle.html#object.__getstate__)
...
In addition to the examples presented here have a look at FreeCAD source code [here](https://github.com/FreeCAD/FreeCAD/blob/master/src/Mod/TemplatePyMod/FeaturePython.py) for more examples.
